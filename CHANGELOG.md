...
- **pnpm caching**: Cache de store entre runs para builds mais rápidos
- **Playwright report**: Upload de artifacts quando testes falham
- **Pre-commit hooks**: Husky + lint-staged para lint automático antes de commits
- **Deploy só roda após E2E passar**: `needs: [gate, e2e]`
