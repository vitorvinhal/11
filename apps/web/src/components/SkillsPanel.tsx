    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg bg-white/[0.06] px-2.5 py-1.5 text-[11px] text-text-muted hover:bg-white/[0.1] hover:text-text-primary transition"
        >
            ...
            {skills.length === 0 && (
              <div className="rounded-xl bg-white/[0.03] p-6 text-center">
                ...
                <p className="mt-1 text-xs text-text-dim">
                  Clique em &quot;Add&quot; para explorar o catálogo.
                </p>
              </div>
            )}
            {skills.map((sk) => (
              <div
                key={sk.id}
                className="group flex items-center gap-3 rounded-xl bg-white/[0.03] px-3 py-2.5 hover:bg-white/[0.05] transition"
              >
          ...
          {category === "Todos" && !search && (
            <div className="rounded-xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 p-4">
              ...
              <div className="mt-1 text-xs text-text-dim">
                Query, chart e explique seus dados — SQL, planilhas e dashboards
                em um só lugar.
              </div>
              <button
                onClick={() =>
                  void addFromCatalog(
                    SKILL_CATALOG.find((s) => s.id === "data-visualization")!,
                  )
                }
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-[10px] text-text-dim">
                      from {item.author} — {item.category}
                    </div>
                  </div>
                  {isInstalled ? (
