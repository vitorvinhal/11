...
export const astroMonarchLanguage: Monaco.languages.IMonarchLanguage = {
  ...
  tokenizer: {
    ...
    frontmatter: [
      [
        /^---\s*$/,
        { token: "keyword", switchTo: "@markupReenter", nextEmbedded: "@pop" },
      ],
    ],
    ...
    markup: [
      ...
      [
        /<style(?=\s|>)/,
        { token: "tag", switchTo: "@styleOpen.css", nextEmbedded: "@pop" },
      ],
      [
        /<!--/,
    ...
    scriptOpen: [
      ...
      [
        /lang(?=\s*=)/,
        { token: "attribute.name", switchTo: "@scriptLangBeforeEquals.$S2" },
      ],
    ...
    scriptBody: [
      [
        /<\/script\s*>/,
        { token: "tag", switchTo: "@markupReenter", nextEmbedded: "@pop" },
      ],
    ],
    ...
    styleOpen: [
      ...
      [
        /lang(?=\s*=)/,
        { token: "attribute.name", switchTo: "@styleLangBeforeEquals.$S2" },
      ],
      { include: "@tagAttributes" },
    ],
    ...
    styleLangValue: [
      ...
      [
        /scss(?=\s|\/|>|$)/,
        { token: "attribute.value", switchTo: "@styleOpen.scss" },
      ],
      ...
      [
        /less(?=\s|\/|>|$)/,
        { token: "attribute.value", switchTo: "@styleOpen.less" },
      ],
      [/"css"/, { token: "attribute.value", switchTo: "@styleOpen.css" }],
      [/'css'/, { token: "attribute.value", switchTo: "@styleOpen.css" }],
      [
        /css(?=\s|\/|>|$)/,
        { token: "attribute.value", switchTo: "@styleOpen.css" },
      ],
