...
import { D as getThemeVariables3, H as setAccDescription, K as setDiagramTitle, U as setAccTitle, a as clear, c as configureSvgSize, f as defaultConfig_default, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle, z as sanitizeText } from "./chunk-DU6HZSFF-Rlm_otCx.js";
...
var parser = (function() {
	var t = /* @__PURE__ */ __name(function(e, t, n, r) {
		...
		66,
		67
	], ee = [1, 66], te = [1, 67], ne = [1, 68], re = [1, 69], ie = [1, 70], ae = [1, 71], oe = [1, 72], se = [1, 73], ce = [1, 74], le = [1, 75], ue = [1, 76], de = [1, 77], V = [
		4,
		5,
		6,
		7,
		...
		15,
		18
	], H = [1, 91], U = [1, 92], W = [1, 93], G = [1, 100], K = [1, 94], q = [1, 97], J = [1, 95], Y = [1, 96], X = [1, 98], Z = [1, 99], fe = [1, 103], pe = [
		10,
		55,
		56,
		57
	...
	return __name($, "Parser"), $.prototype = me, me.Parser = $, new $();
})();
...
function textSanitizer(e) {
	return sanitizeText(e.trim(), getConfig2());
}
...
var diagram = {
	...
	renderer: { draw: /* @__PURE__ */ __name((r, i, a, o) => {
		...
		let h = select_default(p === "sandbox" ? m.nodes()[0].contentDocument.body : "body").select(`[id="${i}"]`), g = h.append("g").attr("class", "main"), _ = d.quadrantChart?.chartWidth ?? 500, v = d.quadrantChart?.chartHeight ?? 500;
