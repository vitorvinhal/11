...
import { H as setAccDescription, U as setAccTitle, c as configureSvgSize, r as assignWithDepth_default, s as common_default, v as getAccDescription, x as getConfig2, y as getAccTitle, z as sanitizeText } from "./chunk-DU6HZSFF-Rlm_otCx.js";
import "./purify.es-Ddnop6vN.js";
import "./dist-DRK-BflQ.js";
import { i as calculateTextWidth, r as calculateTextHeight, v as wrapLabel } from "./chunk-75Z2AOVW-DlWr2fif.js";
...
var parser = (function() {
	...
	return __name($e, "Parser"), $e.prototype = Qe, Qe.Parser = $e, new $e();
})();
parser.parser = parser;
var c4Diagram_default = parser, getRequiredConfig = /* @__PURE__ */ __name((e) => getConfig2()[e], "getRequiredConfig"), assignAttributes = /* @__PURE__ */ __name((e, t) => {
	for (let [n, r] of Object.entries(t)) if (r !== void 0) if (typeof r == "object") {
		let [t, n] = Object.entries(r)[0];
		e[t] = n;
	} else e[n] = r;
}, "assignAttributes"), createGlobalBoundary = /* @__PURE__ */ __name(() => ({
	alias: "global",
	label: { text: "global" },
	type: { text: "global" },
	tags: null,
	link: null,
	parentBoundary: ""
}), "createGlobalBoundary"), c4ShapeArray = [], boundaryParseStack = [""], currentBoundaryParse = "global", parentBoundaryParse = "", boundaries = [createGlobalBoundary()], rels = [], title = "", wrapEnabled = !1, c4ShapeInRow = 4, c4BoundaryInRow = 2, c4Type, getC4Type = /* @__PURE__ */ __name(function() {
	return c4Type;
	...
	clear: /* @__PURE__ */ __name(function() {
		c4ShapeArray = [], boundaries = [createGlobalBoundary()], parentBoundaryParse = "", currentBoundaryParse = "global", boundaryParseStack = [""], rels = [], boundaryParseStack = [""], title = "", wrapEnabled = !1, c4ShapeInRow = 4, c4BoundaryInRow = 2;
	}, "clear"),
	LINETYPE: {
		SOLID: 0,
		DOTTED: 1,
	...
	return drawRect(e, t);
}, "drawRect"), drawRels = /* @__PURE__ */ __name((e, t, n, r) => {
	...
	for (let e of t) {
		...
		_drawTextCandidateFunc(n)(e.label.text, i, Math.min(e.startPoint.x, e.endPoint.x) + Math.abs(e.endPoint.x - e.startPoint.x) / 2 + s, Math.min(e.startPoint.y, e.endPoint.y) + Math.abs(e.endPoint.y - e.startPoint.y) / 2 + l, u, e.label.height, { fill: t }, d), e.techn && e.techn.text !== "" && (d = n.messageFont(), _drawTextCandidateFunc(n)("[" + e.techn.text + "]", i, Math.min(e.startPoint.x, e.endPoint.x) + Math.abs(e.endPoint.x - e.startPoint.x) / 2 + s, Math.min(e.startPoint.y, e.endPoint.y) + Math.abs(e.endPoint.y - e.startPoint.y) / 2 + n.messageFontSize + 5 + l, Math.max(u, e.techn.width), e.techn.height, {
			fill: t,
			"font-style": "italic"
		}, d));
	}
...
}, "drawBoundary"), insertDatabaseIcon = /* @__PURE__ */ __name(function(e, t) {
...
}, "insertArrowCrossHead"), _drawTextCandidateFunc = /* @__PURE__ */ (function() {
	...
	insertComputerIcon,
	insertClockIcon
}, getDiagramRoot = /* @__PURE__ */ __name((e, t) => {
	if (t === "sandbox") {
		let t = select_default("#i" + e).node()?.contentDocument;
		if (!t) throw Error(`Sandbox iframe #i${e} is missing its content document`);
		return {
			root: select_default(t.body),
			doc: t
		};
	}
	return {
...
}, "getDiagramRoot"), QUEUE_SHAPES = /* @__PURE__ */ new Set([
	"system_queue",
	...
	pipe: "h-cyl",
	component: "fr-rect"
}, keywordShape = /* @__PURE__ */ __name((e) => e ? SHAPE_KEYWORDS[e.toLowerCase()] : void 0, "keywordShape"), resolveNodeShape = /* @__PURE__ */ __name((e) => {
	let t = keywordShape(e.shape) ?? keywordShape(e.sprite);
	if (t) return t;
	if (e.tags) for (let t of e.tags.split(",")) {
		let e = keywordShape(t.trim());
		if (e) return e;
	}
	let n = e.typeC4Shape.text;
	return n === "person" || n === "external_person" ? "person" : DB_SHAPES.has(n) ? "cylinder" : QUEUE_SHAPES.has(n) ? "h-cyl" : "rounded";
}, "resolveNodeShape"), STEREOTYPE_NAMES = {
	person: "Person",
	system: "Software System",
	container: "Container",
	component: "Component"
}, stereotypeLabel = /* @__PURE__ */ __name((e) => {
	let t = e.replace(/^external_/, "").replace(/_(db|queue)$/, "");
	return STEREOTYPE_NAMES[t] ?? t.replace(/_/g, " ");
}, "stereotypeLabel"), isExternal = /* @__PURE__ */ __name((e) => e.startsWith("external_"), "isExternal"), stereotypeText = /* @__PURE__ */ __name((e) => {
	let t = stereotypeLabel(e.typeC4Shape.text);
	return e.techn?.text ? `[${t}: ${e.techn.text}]` : `[${t}]`;
}, "stereotypeText"), C4_ELEMENT_TYPES = [
	"person",
	"system",
	"system_db",
	"system_queue",
	...
	"component_db",
	"component_queue"
].flatMap((e) => [e, `external_${e}`]), C4_ELEMENT_TYPE_SET = new Set(C4_ELEMENT_TYPES), isC4ElementType = /* @__PURE__ */ __name((e) => C4_ELEMENT_TYPE_SET.has(e), "isC4ElementType"), elementCssStyles = /* @__PURE__ */ __name((e, t) => {
	let n = e.typeC4Shape.text, r = e.bgColor ?? (isC4ElementType(n) && t[`${n}_bg_color`]), i = e.borderColor ?? (isC4ElementType(n) && t[`${n}_border_color`]), a = [];
	return r && a.push(`fill:${r}`), i && a.push(`stroke:${i}`), a.push(`color:${e.fontColor ?? "#FFFFFF"}`), a;
}, "elementCssStyles"), buildC4Node = /* @__PURE__ */ __name((e, t, n, r, i) => {
	let a = e.typeC4Shape.text, o = ["c4-shape", `c4-${a}`];
	isExternal(a) && o.push("c4-external");
	let s = resolveNodeShape(e), l = elementCssStyles(e, t);
	return (s === "rounded" || s === "fr-rect") && l.push("rx:12px", "ry:12px"), {
		id: e.alias,
		label: e.label.text,
		stereotype: stereotypeText(e),
...
}, "buildC4Node"), globalBoundaryMaxX = 0, globalBoundaryMaxY = 0, c4ShapeInRow2 = 4, c4BoundaryInRow2 = 2;
...
var conf = {}, Bounds = class {
	...
	insert(e) {
		...
		(r >= n || i >= n || this.nextData.cnt > c4ShapeInRow2) && (r = this.nextData.startx + e.margin + conf.nextLinePaddingX, a = this.nextData.stopy + e.margin * 2, this.nextData.stopx = i = r + e.width, this.nextData.starty = this.nextData.stopy, this.nextData.stopy = o = a + e.height, this.nextData.cnt = 1), e.x = r, e.y = a, this.updateVal(this.data, "startx", r, Math.min), this.updateVal(this.data, "starty", a, Math.min), this.updateVal(this.data, "stopx", i, Math.max), this.updateVal(this.data, "stopy", o, Math.max), this.updateVal(this.nextData, "startx", r, Math.min), this.updateVal(this.nextData, "starty", a, Math.min), this.updateVal(this.nextData, "stopx", i, Math.max), this.updateVal(this.nextData, "stopy", o, Math.max);
	}
	init(e) {
		this.name = "", this.data = {
			startx: void 0,
...
}, "setConf"), boundaryFont = /* @__PURE__ */ __name((e) => ({
...
function calcC4ShapeTextWH(e, t, n, r, i) {
	let a = t[e];
	if (!a.width) if (n) a.text = wrapLabel(a.text, i, r), a.textLines = a.text.split(common_default.lineBreakRegex).length, a.width = i, a.height = calculateTextHeight(a.text, r);
	else {
		let e = a.text.split(common_default.lineBreakRegex);
		a.textLines = e.length;
		let t = 0;
		a.height = 0, a.width = 0;
		for (let n of e) a.width = Math.max(calculateTextWidth(n, r), a.width), t = calculateTextHeight(n, r), a.height += t;
	}
	return a;
}
...
var drawBoundary2 = /* @__PURE__ */ __name(function(e, t, n) {
	...
	t.x = r, t.y = i, t.width = n.data.stopx - r, t.height = n.data.stopy - i, t.label.y = conf.c4ShapeMargin - 35;
	let a = t.wrap && conf.wrap, o = boundaryFont(conf);
	o.fontSize += 2, o.fontWeight = "bold", calcC4ShapeTextWH("label", t, a, o, calculateTextWidth(t.label.text, o)), svgDraw_default.drawBoundary(e, t, conf);
}, "drawBoundary"), drawC4ShapeArray = /* @__PURE__ */ __name(async function(t, n, r, i) {
	let a = getConfig2(), o = a.look ?? "classic", s = { config: a }, l = n.attr("id") ?? "", d = i.map((e) => r[Number(e)]), f = /* @__PURE__ */ __name((e) => {
		let t = e.shape ? shapes[e.shape] : void 0;
		if (!t) throw Error(`C4: no shape handler for "${e.shape}"`);
		return t;
	}, "shapeHandlerFor");
	await Promise.all(d.map(async (e) => {
		let t = buildC4Node(e, conf, conf.c4ShapePadding, o, conf.width);
		t.domId = `${l}-${t.id}`;
		let r = await f(t)(n, t, s);
		e.width = t.width ?? conf.width, e.height = t.height ?? conf.height, e.margin = conf.c4ShapeMargin, r.remove();
	}));
	...
	})), t.bumpLastMargin(conf.c4ShapeMargin);
	...
	for (let e of t) {
		o += 1;
		let t = e.wrap && conf.wrap, r = messageFont(conf);
		a === "C4Dynamic" && (e.label.text = o + ": " + e.label.text);
		let i = calculateTextWidth(e.label.text, r);
		calcC4ShapeTextWH("label", e, t, r, i), e.techn && e.techn.text !== "" && (i = calculateTextWidth(e.techn.text, r), calcC4ShapeTextWH("techn", e, t, r, i)), e.descr && e.descr.text !== "" && (i = calculateTextWidth(e.descr.text, r), calcC4ShapeTextWH("descr", e, t, r, i));
		let s = n(e.from), l = n(e.to);
		if (!s || !l) throw Error(`C4 rel "${e.from}" -> "${e.to}" references an unknown shape`);
		let u = getIntersectPoints(s, l);
...
async function drawInsideBoundary(e, t, n, r, i) {
	let a = i.db, o = new Bounds(i);
	o.data.widthLimit = n.data.widthLimit / Math.min(c4BoundaryInRow2, r.length);
	for (let [s, l] of r.entries()) {
		...
		let u = l.wrap && conf.wrap, d = boundaryFont(conf);
		d.fontSize += 2, d.fontWeight = "bold";
		let f = calcC4ShapeTextWH("label", l, u, d, o.data.widthLimit);
		if (f.Y = r + 8, r = f.Y + f.height, l.type && l.type.text !== "") {
			l.type.text = "[" + l.type.text + "]";
			let e = calcC4ShapeTextWH("type", l, u, boundaryFont(conf), o.data.widthLimit);
			e.Y = r + 5, r = e.Y + e.height;
		}
		if (l.descr && l.descr.text !== "") {
			let e = boundaryFont(conf);
			e.fontSize -= 2;
			let t = calcC4ShapeTextWH("descr", l, u, e, o.data.widthLimit);
			t.Y = r + 20, r = t.Y + t.height;
		}
		if (s == 0 || s % c4BoundaryInRow2 === 0) {
			let e = n.data.startx + conf.diagramMarginX, t = n.data.stopy + conf.diagramMarginY + r;
			o.setData(e, e, t, t);
		} else {
			let e = o.data.stopx === o.data.startx ? o.data.startx : o.data.stopx + conf.diagramMarginX, t = o.data.starty;
			o.setData(e, e, t, t);
		}
		o.name = l.alias;
		let p = a.getC4ShapeArray(l.alias), m = a.getC4ShapeKeys(l.alias);
		m.length > 0 && await drawC4ShapeArray(o, e, p, m), t = l.alias;
		let h = a.getBoundaries(t);
		h.length > 0 && await drawInsideBoundary(e, t, o, h, i), l.alias !== "global" && drawBoundary2(e, l, o), n.data.stopy = Math.max(o.data.stopy + conf.c4ShapeMargin, n.data.stopy), n.data.stopx = Math.max(o.data.stopx + conf.c4ShapeMargin, n.data.stopx), globalBoundaryMaxX = Math.max(globalBoundaryMaxX, n.data.stopx), globalBoundaryMaxY = Math.max(globalBoundaryMaxY, n.data.stopy);
	}
}
...
var c4Renderer_default = {
	...
	draw: /* @__PURE__ */ __name(async function(e, n, r, i) {
		...
		let o = getConfig2().securityLevel, { root: s } = getDiagramRoot(n, o), l = i.db;
		l.setWrap(conf.wrap), c4ShapeInRow2 = l.getC4ShapeInRow(), c4BoundaryInRow2 = l.getC4BoundaryInRow(), log.debug(`C:${JSON.stringify(conf, null, 2)}`);
		let d = s.select(`[id="${n}"]`);
		svgDraw_default.insertComputerIcon(d, n), svgDraw_default.insertDatabaseIcon(d, n), svgDraw_default.insertClockIcon(d, n);
		let f = new Bounds(i);
		f.setData(conf.diagramMarginX, conf.diagramMarginX, conf.diagramMarginY, conf.diagramMarginY), f.data.widthLimit = screen.availWidth, globalBoundaryMaxX = conf.diagramMarginX, globalBoundaryMaxY = conf.diagramMarginY;
		let p = l.getTitle();
		await drawInsideBoundary(d, "", f, l.getBoundaries(""), i), svgDraw_default.insertArrowHead(d, n), svgDraw_default.insertArrowEnd(d, n), svgDraw_default.insertArrowCrossHead(d, n), svgDraw_default.insertArrowFilledHead(d, n), drawRels2(d, l.getRels(), l.getC4Shape, i, n), f.data.stopx = globalBoundaryMaxX, f.data.stopy = globalBoundaryMaxY;
		let m = f.data, h = m.startx, g = m.starty, _ = globalBoundaryMaxY - g + 2 * conf.diagramMarginY, v = globalBoundaryMaxX - h, y = v + 2 * conf.diagramMarginX;
		p && d.append("text").text(p).attr("x", v / 2 - 4 * conf.diagramMarginX).attr("y", g + conf.diagramMarginY), configureSvgSize(d, _, y, conf.useMaxWidth);
		let x = p ? 60 : 0;
		d.attr("viewBox", h - conf.diagramMarginX + " -" + (conf.diagramMarginY + x) + " " + y + " " + (_ + x)), log.debug("models:", m);
	}, "draw")
}, elementFontStyles = /* @__PURE__ */ __name(() => {
	let e = getConfig2().c4 ?? {}, t = new CSSStyleSheet();
	for (let n of C4_ELEMENT_TYPES) {
