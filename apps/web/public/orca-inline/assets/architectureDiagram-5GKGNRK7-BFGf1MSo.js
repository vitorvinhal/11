...
import { H as setAccDescription, J as setupGraphViewbox, K as setDiagramTitle, U as setAccTitle, a as clear, b as getConfig, f as defaultConfig_default, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle, z as sanitizeText } from "./chunk-DU6HZSFF-Rlm_otCx.js";
import "./purify.es-Ddnop6vN.js";
import "./dist-DRK-BflQ.js";
import { a as cleanAndMerge, l as getEdgeId } from "./chunk-75Z2AOVW-DlWr2fif.js";
...
import { i as unknownIcon, r as registerIconPacks, t as getIconSVG } from "./chunk-PWAF6VOD-xw3v3CBz.js";
import { n as createText } from "./chunk-GMAD6QVW-CrbOfuRD.js";
import { t as cytoscape$1 } from "./cytoscape.esm-vqX_q2BI.js";
var require_layout_base = /* @__PURE__ */ __commonJSMin(((e, t) => {
...
}, "isArchitectureJunction"), architectureGroupAlignmentKey = /* @__PURE__ */ __name((e, t) => {
	let [n, r] = [e, t].sort();
	return `${JSON.stringify(n)}-${JSON.stringify(r)}`;
}, "architectureGroupAlignmentKey"), edgeData = /* @__PURE__ */ __name((e) => e.data(), "edgeData"), nodeData = /* @__PURE__ */ __name((e) => e.data(), "nodeData"), DEFAULT_ARCHITECTURE_CONFIG = defaultConfig_default.architecture, ArchitectureDB = class {
	constructor() {
		this.nodes = /* @__PURE__ */ new Map(), this.groups = /* @__PURE__ */ new Map(), this.edges = [], this.layoutHints = [], this.registeredIds = /* @__PURE__ */ new Map(), this.elements = /* @__PURE__ */ new Map(), this.diagramId = "", this.setAccTitle = setAccTitle, this.getAccTitle = getAccTitle, this.setDiagramTitle = setDiagramTitle, this.getDiagramTitle = getDiagramTitle, this.getAccDescription = getAccDescription, this.setAccDescription = setAccDescription, this.clear();
	}
	...
	clear() {
		this.nodes = /* @__PURE__ */ new Map(), this.groups = /* @__PURE__ */ new Map(), this.edges = [], this.layoutHints = [], this.registeredIds = /* @__PURE__ */ new Map(), this.dataStructures = void 0, this.elements = /* @__PURE__ */ new Map(), this.diagramId = "", clear();
	}
		...
		if (this.dataStructures === void 0) {
			...
			for (let [n, r] of this.nodes.entries()) {
				...
				for (let t of r.edges) {
					...
					if (r && a && r !== a) {
						let n = getArchitectureDirectionAlignment(t.lhsDir, t.rhsDir);
						n !== "bend" && e.set(architectureGroupAlignmentKey(r, a), n);
					}
					if (t.lhsId === n) {
						let e = getArchitectureDirectionPair(t.lhsDir, t.rhsDir);
						e && i.set(e, t.rhsId);
					} else {
						let e = getArchitectureDirectionPair(t.rhsDir, t.lhsDir);
						e && i.set(e, t.lhsId);
					}
				}
				t.set(n, i);
			}
			let r = /* @__PURE__ */ new Set(), i = new Set(t.keys()), a = /* @__PURE__ */ __name((e) => {
				let n = /* @__PURE__ */ new Map([[e, [0, 0]]]), a = [e];
				for (; a.length > 0;) {
					let e = a.shift();
					if (e) {
						r.add(e), i.delete(e);
						...
						let [c, l] = s;
						o.forEach((e, t) => {
							r.has(e) || (n.set(e, shiftPositionByArchitectureDirectionPair([c, l], t)), a.push(e));
						});
					}
				}
				return n;
...
var wrapIcon = /* @__PURE__ */ __name((e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`, "wrapIcon"), architectureIcons = {
...
}, drawEdges = /* @__PURE__ */ __name(async function(e, t, n, r) {
	let i = n.getConfigField("padding"), a = n.getConfigField("iconSize"), o = a / 2, s = a / 6, c = s / 2;
	await Promise.all(t.edges().map(async (t) => {
		let { source: a, sourceDir: l, sourceArrow: u, sourceGroup: d, target: f, targetDir: p, targetArrow: h, targetGroup: g, label: _ } = edgeData(t), { x: y, y: b } = t[0].sourceEndpoint(), { x, y: S } = t[0].midpoint(), { x: C, y: w } = t[0].targetEndpoint(), E = i + 4;
		if (d && (isArchitectureDirectionX(l) ? y += l === "L" ? -E : E : b += l === "T" ? -E : E + 18), g && (isArchitectureDirectionX(p) ? C += p === "L" ? -E : E : w += p === "T" ? -E : E + 18), !d && n.getNode(a)?.type === "junction" && (isArchitectureDirectionX(l) ? y += l === "L" ? o : -o : b += l === "T" ? o : -o), !g && n.getNode(f)?.type === "junction" && (isArchitectureDirectionX(p) ? C += p === "L" ? o : -o : w += p === "T" ? o : -o), t[0]._private.rscratch) {
			let t = e.insert("g");
			if (t.insert("path").attr("d", `M ${y},${b} L ${x},${S} L${C},${w} `).attr("class", "edge").attr("id", `${r}-${getEdgeId(a, f, { prefix: "L" })}`), u) {
				let e = isArchitectureDirectionX(l) ? ArchitectureDirectionArrowShift[l](y, s) : y - c, n = isArchitectureDirectionY(l) ? ArchitectureDirectionArrowShift[l](b, s) : b - c;
			...
			if (_) {
				...
				n = e === "X" ? Math.abs(y - C) : e === "Y" ? Math.abs(b - w) / 1.5 : Math.abs(y - C) / 2;
				let r = t.append("g");
				if (await createText(r, _, {
					useHtmlLabels: !1,
					width: n,
					classes: "architecture-service-label"
				}, getConfig2()), r.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), e === "X") r.attr("transform", "translate(" + x + ", " + S + ")");
...
}, "drawEdges"), drawGroups = /* @__PURE__ */ __name(async function(e, t, n, r) {
	...
	await Promise.all(t.nodes().map(async (t) => {
		...
		if (s.type === "group") {
			...
			if (s.label) {
				let e = p.append("g");
				await createText(e, s.label, {
					useHtmlLabels: !1,
					width: l,
					classes: "architecture-service-label"
				}, getConfig2()), e.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), e.attr("transform", "translate(" + (h + o + 4) + ", " + (g + o + 2) + ")");
			}
			n.setElementForId(s.id, f);
		}
	}));
}, "drawGroups"), drawServices = /* @__PURE__ */ __name(async function(e, t, n, r) {
	let i = getConfig2();
	for (let a of n) {
		let n = t.append("g"), o = e.getConfigField("iconSize");
		if (a.title) {
			let e = n.append("g");
			await createText(e, a.title, {
				useHtmlLabels: !1,
				width: o * 1.5,
				classes: "architecture-service-label"
		...
		let s = n.append("g");
		if (a.icon) s.html(`<g>${await getIconSVG(a.icon, {
			height: o,
			width: o,
			fallbackPrefix: architectureIcons.prefix
		})}</g>`);
		else if (a.iconText) {
			s.html(`<g>${await getIconSVG("blank", {
				height: o,
				width: o,
				fallbackPrefix: architectureIcons.prefix
			})}</g>`);
			let e = s.append("g").append("foreignObject").attr("width", o).attr("height", o).append("div").attr("class", "node-icon-text").attr("style", `height: ${o}px;`).append("div").html(sanitizeText(a.iconText, i)), t = parseInt(window.getComputedStyle(e.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
	...
	return 0;
}, "drawServices"), drawJunctions = /* @__PURE__ */ __name(function(e, t, n, r) {
	n.forEach((n) => {
...
function getAlignments(e, t, r, i = []) {
	let a = /* @__PURE__ */ __name((e, t) => {
		...
		for (let [i, a] of e.entries()) {
			...
			for (let i = 0; i < s.length - 1; i++) for (let a = i + 1; a < s.length; a++) {
				let [c, l] = s[i], [u, d] = s[a];
				if (r.get(architectureGroupAlignmentKey(c, u)) === t) n.set(e, [
					...n.get(e) ?? [],
					...l,
					...d
				]);
				else if (c === "default" || u === "default") n.set(e, [
					...n.get(e) ?? [],
					...l,
					...d
				]);
	...
	let l = /* @__PURE__ */ __name((e) => e.filter((e) => !e.some((e) => c.has(e))), "dropOverlapping"), u = l(o), d = l(s);
	return i.forEach((e) => {
...
function getRelativeConstraints(e, t, r = []) {
	...
	let l = /* @__PURE__ */ __name((e) => `${e[0]},${e[1]}`, "posToStr"), u = /* @__PURE__ */ __name((e) => e.split(",").map((e) => parseInt(e)), "strToPos");
	return e.forEach((e) => {
				...
				if (d) {
					...
					Object.entries(s).forEach(([e, s]) => {
						...
						if (p && !r[u]) {
							...
							i.push({
								[ArchitectureDirectionName[e]]: p,
								[ArchitectureDirectionName[getOppositeArchitectureDirection(e)]]: d,
								gap: o * a
							});
						}
					});
...
function layoutArchitecture(e, t, a, o, s, { spatialMaps: c, groupAlignments: l }) {
	return new Promise((u) => {
		...
		let p = s.getLayoutHints(), m = getAlignments(s, c, l, p), h = getRelativeConstraints(c, s, p), g = s.getConfigField("iconSize"), _ = s.getConfigField("idealEdgeLengthMultiplier") * g, v = .5 * g, y = s.getConfigField("edgeElasticity"), b = s.getConfigField("seed"), x = f.layout({
			name: "fcose",
			quality: "proof",
		...
		x.one("layoutstop", () => {
			...
			f.endBatch(), withSeededRandom(b, () => x.run());
		});
		try {
			withSeededRandom(b, () => x.run());
		} catch (e) {
...
var diagram = {
	...
	renderer: { draw: /* @__PURE__ */ __name(async (e, t, n, r) => {
		let i = r.db;
		i.setDiagramId(t);
		let a = i.getServices(), s = i.getJunctions(), c = i.getGroups(), l = i.getEdges(), u = i.getDataStructures(), d = selectSvgElement(t), f = d.append("g");
		f.attr("class", "architecture-edges");
		let p = d.append("g");
		p.attr("class", "architecture-services");
		let m = d.append("g");
		m.attr("class", "architecture-groups"), await drawServices(i, p, a, t), drawJunctions(i, p, s, t);
		let h = await layoutArchitecture(a, s, c, l, i, u);
		await drawEdges(f, h, i, t), await drawGroups(m, h, i, t), positionNodes(i, h), setupGraphViewbox(void 0, d, i.getConfigField("padding"), i.getConfigField("useMaxWidth"));
	}, "draw") },
