...
import { H as setAccDescription, K as setDiagramTitle, U as setAccTitle, a as clear, rt as rgba_default, s as common_default, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle } from "./chunk-DU6HZSFF-Rlm_otCx.js";
...
var erDiagram_default = parser, ErDB = class {
	...
	addSubGraph(t, r, i) {
		let a = t.text.trim(), o = i.text, s = (/* @__PURE__ */ __name((e) => {
		...
		return log.info("Adding", u.id, u.nodes, u.dir), u.nodes = this.makeUniq(u, this.subGraphs).nodes, this.subGraphs.push(u), this.subGraphLookup.set(a, u), a;
	}
	getSubGraphs() {
	...
	makeUniq(e, t) {
		...
		return e.nodes.forEach((t, a) => {
			r.has(t) ? log.warn(`Entity '${t}' already belongs to another subgraph and will be ignored`) : i.push(e.nodes[a]);
		}), { nodes: i };
	}
	sanitizeText(e) {
		return common_default.sanitizeText(e, getConfig2());
	}
	...
	clear() {
		this.entities = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.relationships = [], this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.subgraphDepth = 0, clear();
	}
	getData() {
		let e = [], t = [], n = getConfig2(), r = this.getSubGraphs(), i = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map();
...
var draw = /* @__PURE__ */ __name(async function(e, t, i, a) {
	log.info("REF0:"), log.info("Drawing er diagram (unified)", t);
	let { securityLevel: o, er: s, layout: c } = getConfig2(), l = a.db.getData(), u = getDiagramElement(t, o);
	l.type = a.type, l.layoutAlgorithm = getRegisteredLayoutAlgorithm(c), l.config.flowchart.nodeSpacing = s?.nodeSpacing || 140, l.config.flowchart.rankSpacing = s?.rankSpacing || 80, l.direction = a.db.getDirection();
	...
	}), utils_default.insertTitle(u, "erDiagramTitleText", s?.titleTopMargin ?? 25, a.db.getDiagramTitle()), setupViewPortForSVG(u, 8, "erDiagram", s?.useMaxWidth ?? !0);
