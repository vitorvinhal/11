...
import { $ as darken_default, J as setupGraphViewbox, et as lighten_default, f as defaultConfig_default, nt as is_dark_default, x as getConfig2, z as sanitizeText } from "./chunk-DU6HZSFF-Rlm_otCx.js";
...
var kanban_default = parser, nodes = [], sections = [], cnt = 0, elements = {}, clear = /* @__PURE__ */ __name(() => {
...
}, kanbanRenderer_default = { draw: /* @__PURE__ */ __name(async (e, n, i, o) => {
	log.debug("Rendering kanban diagram\n" + e);
	let c = o.db.getData(), u = getConfig2();
	u.htmlLabels = !1;
	let m = selectSvgElement(n);
	...
	for (let e of _) {
		let t = y[x];
		x += 1;
		let n = u?.kanban?.sectionWidth || 200, r = -n * 3 / 2 + b, i = r, a = c.nodes.filter((t) => t.parentId === e.id);
		for (let t of a) {
	...
	let a = /* @__PURE__ */ __name((e, r) => t.darkMode ? darken_default(e, r) : lighten_default(e, r), "adjuster");
    ...
    .section-${e - 1} rect, .section-${e - 1} path, .section-${e - 1} circle, .section-${e - 1} polygon, .section-${e - 1} path  {
      fill: ${a(t["cScale" + e], 10)};
      stroke: ${a(t["cScale" + e], 10)};
