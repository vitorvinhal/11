...
function createCytoscapeInstance(e) {
	return new Promise((t) => {
		let n = select_default("body").append("div").attr("id", "cy").attr("style", "display:none"), o = cytoscape$1({
		...
		n.remove(), addNodes(e.nodes, o), addEdges(e.edges, o), o.nodes().forEach(function(e) {
			e.layoutDimensions = () => {
				let t = e.data();
				return {
					w: t.width,
...
async function executeCoseBilkentLayout(e, t) {
	...
	try {
		...
		let t = await createCytoscapeInstance(e), n = extractPositionedNodes(t), i = extractPositionedEdges(t);
		return log.debug(`Layout completed: ${n.length} nodes, ${i.length} edges`), {
			nodes: n,
			edges: i
		};
	} catch (e) {
