...
import { H as setAccDescription, K as setDiagramTitle, U as setAccTitle, a as clear, b as getConfig, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle } from "./chunk-DU6HZSFF-Rlm_otCx.js";
...
var requirementDiagram_default = parser, RequirementDB = class {
...
}, genColor = /* @__PURE__ */ __name((e) => {
	let { themeVariables: t, look: n } = getConfig(), { bkgColorArray: r, borderColorArray: i } = t;
	if (!i?.length) return "";
	let a = "";
    ...
    `;
	return a;
}, "genColor"), styles_default = /* @__PURE__ */ __name((e) => {
	let { look: t, themeVariables: n } = getConfig(), { requirementEdgeLabelBackground: r } = n;
	return `
  ${genColor(e)}
  marker {
...
var draw = /* @__PURE__ */ __name(async function(e, t, r, i) {
	...
	let { securityLevel: a, state: o, layout: s, look: c } = getConfig2(), l = i.db.getData(), d = getDiagramElement(t, a);
	l.type = i.type, l.layoutAlgorithm = getRegisteredLayoutAlgorithm(s), l.nodeSpacing = o?.nodeSpacing ?? 50, l.rankSpacing = o?.rankSpacing ?? 50, l.markers = c === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], l.diagramId = t, await render(l, d), utils_default.insertTitle(d, "requirementDiagramTitleText", o?.titleTopMargin ?? 25, i.db.getDiagramTitle()), setupViewPortForSVG(d, 8, "requirementDiagram", o?.useMaxWidth ?? !0);
}, "draw"), diagram = {
