...
import { G as setConfig2, H as setAccDescription, K as setDiagramTitle, U as setAccTitle, a as clear, d as defaultConfig2, k as getUserDefinedConfig, rt as rgba_default, s as common_default, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle } from "./chunk-DU6HZSFF-Rlm_otCx.js";
import { t as channel_default } from "./channel-BOnYEfIe.js";
import { t as purify } from "./purify.es-Ddnop6vN.js";
import { _ as utils_default, l as getEdgeId } from "./chunk-75Z2AOVW-DlWr2fif.js";
import { t as getIconStyles } from "./chunk-5VM5RSS4-CZATh3cw.js";
import { i as isValidShape } from "./chunk-4HAMMTFA-C6ufBZSb.js";
...
import { r as render, t as getRegisteredLayoutAlgorithm } from "./chunk-TLUHSLCS-B5wVOksj.js";
...
var MERMAID_DOM_ID_PREFIX = "flowchart-", FlowDB = class {
	...
	addVertex(e, n, r, i, a, o, s = {}, c) {
		...
		if (p === void 0 && (n === void 0 && r === void 0 && i != null && log.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), p = {
			id: e,
			labelType: "text",
			domId: MERMAID_DOM_ID_PREFIX + e + "-" + this.vertexCounter,
			styles: [],
			classes: []
		}, this.vertices.set(e, p)), this.vertexCounter++, n === void 0 ? p.text === void 0 && (p.text = e) : (this.config = getConfig2(), f = this.sanitizeText(n.text.trim()), p.labelType = n.type, f.startsWith("\"") && f.endsWith("\"") && (f = f.substring(1, f.length - 1)), p.text = f), r !== void 0 && (p.type = r), i?.forEach((e) => {
			p.styles.push(e);
		}), a?.forEach((e) => {
			p.classes.push(e);
...
You have to call mermaid.initialize.`);
	...
	setupToolTips(e) {
		...
		select_default(e).select("svg").selectAll("g.node").on("mouseover", (e) => {
			...
			t.transition().duration(200).style("opacity", ".9"), t.text(r.attr("title")).style("left", window.scrollX + a.left + (a.right - a.left) / 2 + "px").style("top", window.scrollY + a.bottom + "px"), t.html(purify.sanitize(i)), r.classed("hover", !0);
		}).on("mouseout", (e) => {
	...
	getData() {
		let t = getConfig2(), n = [], r = [], i = this.getSubGraphs(), a = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map();
		for (let e of i) for (let t of e.nodes) this.subGraphLookup.has(t) && s.set(t, e.id);
		let c = /* @__PURE__ */ __name((e) => this.subGraphLookup.get(e)?.metadata?.view === "collapsed", "isCollapsed"), l = /* @__PURE__ */ __name((e) => {
	...
	var t = /* @__PURE__ */ __name(function(e, t, n, r) {
		...
		124,
		125
	], o = [2, 2], s = [1, 13], c = [1, 14], l = [1, 15], u = [1, 16], d = [1, 23], f = [1, 25], p = [1, 26], ee = [1, 27], m = [1, 50], h = [1, 49], g = [1, 29], te = [1, 30], ne = [1, 31], re = [1, 32], ie = [1, 33], _ = [1, 45], v = [1, 47], y = [1, 43], b = [1, 48], x = [1, 44], S = [1, 51], C = [1, 46], w = [1, 52], T = [1, 53], E = [1, 34], ae = [1, 35], oe = [1, 36], se = [1, 37], ce = [1, 38], D = [1, 58], O = [
		1,
		8,
		9,
		10,
...
var flowParser_default = newParser, fade = /* @__PURE__ */ __name((e, t) => {
  ...
  ${getIconStyles()}
`, "getStyles"), createFlowDiagram = /* @__PURE__ */ __name(({ defaultLayout: t, styles: n = styles_default } = {}) => ({
	...
	init: /* @__PURE__ */ __name((e) => {
		e.flowchart ||= {};
		let n = getUserDefinedConfig().layout ?? t ?? e.layout;
		n && setConfig2({ layout: n }), e.flowchart.arrowMarkerAbsolute = e.arrowMarkerAbsolute, setConfig2({ flowchart: { arrowMarkerAbsolute: e.arrowMarkerAbsolute } });
	}, "init")
}), "createFlowDiagram"), diagram = createFlowDiagram();
