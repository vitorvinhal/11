...
import { H as setAccDescription, K as setDiagramTitle, M as parseGenericTypes, U as setAccTitle, a as clear, s as common_default, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle, z as sanitizeText } from "./chunk-DU6HZSFF-Rlm_otCx.js";
...
var classDiagram_default = parser, visibilityValues = [
...
}, MERMAID_DOM_ID_PREFIX = "classId-", classCounter = 0, sanitizeText2 = /* @__PURE__ */ __name((e) => common_default.sanitizeText(e, getConfig2()), "sanitizeText"), ClassDB = class a {
	constructor() {
	...
	setCssClass(e, t) {
		e.split(",").forEach((e) => {
			let n = e;
			/\d/.exec(e[0]) && (n = MERMAID_DOM_ID_PREFIX + n), n = this.splitClassNameAndType(n).className;
	...
	setLink(e, t, n) {
		...
		e.split(",").forEach((e) => {
			let i = e;
			/\d/.exec(e[0]) && (i = MERMAID_DOM_ID_PREFIX + i), i = this.splitClassNameAndType(i).className;
...
`, "getStyles"), classRenderer_v3_unified_default = {
	...
	draw: /* @__PURE__ */ __name(async function(e, n, r, i) {
		...
		i.db.setDiagramId(n);
		let c = i.db.getData(), l = getDiagramElement(n, a);
