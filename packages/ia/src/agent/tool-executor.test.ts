...
import type { ExecutionContext, ExecutionResult, ExecutionStatus } from './tool-executor';
...
describe('ToolExecutor — FASE 5B', () => {
  ...
  describe('Execution status lifecycle', () => {
    ...
    test('destructive awaiting approval', () => {
      const status: ExecutionStatus = 'awaiting_approval';
